 ...
 * 
 */
public class Performance_OOM_AsynchronousFileChannel_4 implements Runnable {
	...
	private static ThreadPoolExecutor pool = new ThreadPoolExecutor(0, Integer.MAX_VALUE, Long.MAX_VALUE, TimeUnit.MILLISECONDS,
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		try {
			...
			Average average = new PerformanceHarness().calculatePerf(new PerformanceChecker(1000,
					new Performance_OOM_AsynchronousFileChannel_4()), 10);
