...
/**
 * Custom fixed thread group, gracefull closing
 * 
 * @author Niklas Schlimm
 * 
 */
public class Performance_Benchmark_AsynchronousFileChannel_3 implements Runnable {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		try (GracefullChannelCloser closer = new GracefullChannelCloser()) {
			Average average = new PerformanceHarness().calculatePerf(new PerformanceChecker(500,
					new Performance_Benchmark_AsynchronousFileChannel_3()), 5);
