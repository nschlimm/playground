...
public class AsynchronousFileChannel_ShutdownChannelGroupException implements Runnable {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		try {
			AsynchronousFileChannel_ShutdownChannelGroupException task = new AsynchronousFileChannel_ShutdownChannelGroupException();
			int numberOfLoops = 0;
