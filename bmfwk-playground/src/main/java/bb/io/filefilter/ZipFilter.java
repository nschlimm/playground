...
* <p>
* Specificly, this file filter accepts only normal files whose names end with the extension ".zip" (case insensitive).
...
* @author Brent Boyer
*/
public class ZipFilter extends SuffixFilter {
