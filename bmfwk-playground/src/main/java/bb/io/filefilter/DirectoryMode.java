...
public enum DirectoryMode {
	...
	/** Specifies that directories will always be accepted. */
	accept,
	
	/** Specifies that directories will be subjected to the filter's test. */
	test,
	
	/** Specifies that directories will always be rejected. */
	reject;
