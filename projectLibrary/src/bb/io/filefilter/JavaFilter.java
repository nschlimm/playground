...
* <p>
* Specificly, this file filter accepts only normal files whose names end with the extension ".java" (case insensitive).
...
* @author Brent Boyer
*/
public class JavaFilter extends SuffixFilter {
	...
	@Override public String getDescription() { return "Java source files"; }
