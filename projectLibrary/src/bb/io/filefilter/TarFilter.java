...
* <p>
* Specificly, this file filter accepts only normal files whose names end with the extension ".tar" (case insensitive).
...
* @author Brent Boyer
*/
public class TarFilter extends SuffixFilter {
	...
	@Override public String getDescription() { return "TAR files"; }
