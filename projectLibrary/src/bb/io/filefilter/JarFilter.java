...
* <p>
* Specificly, this file filter accepts only normal files whose names end with the extension ".jar" (case insensitive).
...
* @author Brent Boyer
*/
public class JarFilter extends SuffixFilter {
